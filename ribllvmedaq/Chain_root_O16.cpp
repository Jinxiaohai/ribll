...
//         end get data 
    ...
    dist=((si1_60_p_max_e-865)/100)*((si1_60_p_max_e-865)/100)+((tof-136.7)/10)*((tof-136.7)/10);
    if(dist<=1) 
    {
      if(si1_60_p_max_e>350&&si1_60_n_max_e>350) h_si1_O16_posi->Fill(si1_60_p_max_index,si1_60_n_max_index);
      if(si2_60_p_max_e>350&&si2_60_n_max_e>350) h_si2_O16_posi->Fill(15-si2_60_n_max_index,si2_60_p_max_index);
      if(si3_qsd300_max_e>350) h_si3_O16_posi->Fill(si3_qsd300_max_x,si3_qsd300_max_y);
      for (int i=0;i<16;i++)
      {
        if(si4_1000_p_max_e>350) h_si4_O16_posi->Fill(i,15-si4_1000_p_max_index);
      }
